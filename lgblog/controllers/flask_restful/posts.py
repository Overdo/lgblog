...
from lgblog.controllers.flask_restful import fields as jf_fields, parsers
from flask import abort, flash
from lgblog.models import db, User, Post, Tag
import datetime
...
class PostApi(Resource):
    ...
    def get(self, post_id=None):
        ...
        if post_id:
            ...
            if args['users']:
                user = User.query.filter_by(username=args['users']).first()
                if not user:
                    abort(404)
